                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" name="multiple_image"
                                                    id="demo-4" multiple>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-2 pt-1">
                                        ...
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <label class="btn btn-secondary ">
                                                <input type="radio" value="Public" name="options" id="option1"
                                                    autocomplete="off"> Public
                                            </label>
                                            <label class="btn btn-secondary  ">
                                                <input type="radio" value="Privet" name="options" id="option2"
                                                    autocomplete="off"> Privet
                                            </label>
                                        </div>
                                    </div>
                                </div>
