            ...
            <div class="col-lg-10 offset-lg-1">
                ...
                <div class="card mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Products Edit </h6>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{$product->name}}"  value="{{ old('name') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{$product->code}}" value="{{ old('code') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{$product->regular_price}}" class="form-control" value="{{ old('regular_price') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" value="{{$product->selling_price}}" value="{{ old('selling_price') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{$product->discount}}" class="form-control" value="{{ old('discount') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{$product->stock_amount}}" class="form-control" value="{{ old('stock_amount') }}"
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" {{$product->status=='Public'?'checked':''}} value="Public" type="radio" name="status"
                                            >
                                        <label class="form-check-label" for="flexRadioDefault1">
                                            Public
                                        </label>
                                        &nbsp; &nbsp; &nbsp; &nbsp;
                                        <input class="form-check-input" {{$product->status=='Privet'?'checked':''}} value="Privet"  type="radio" name="status">
